...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ivy swiper switch-window exec-path-from-shell projectile iedit auto-yasnippet auto-complete aggressive-indent free-keys dumb-jump highlight-indent-guides doom-modeline magithub magit yasnippet-snippets yasnippet smex ido-vertical-mode ideo-vertical-mode org-bullets beacon spacemacs-theme which-key use-package usepackage))))
