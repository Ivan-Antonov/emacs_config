...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magithub magit yasnippet-snippets yasnippet smex ido-vertical-mode ideo-vertical-mode org-bullets beacon spacemacs-theme which-key use-package usepackage))))
